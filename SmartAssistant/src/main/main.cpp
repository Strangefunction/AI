...
const char *wifiData[][2] = {
    {"PC-oddfunction", "20040801"}, // 替换为自己常用的wifi名和密码
    // {"222", "12345678"},
    // 继续添加需要的 Wi-Fi 名称和密码
};

String APPID = "ad4da98f";
String APIKey = "7494d94cb760b31ae7a0224e9ea2c993";
String APISecret = "ODhjYzk1YTZlNDRiM2IxYTdjZDBjZTA0";
...
const char *appId1 = "ad4da98f"; // 替换为自己的星火大模型参数
const char *domain1 = "generalv3";
const char *websockets_server = "ws://spark-api.xf-yun.com/v3.1/chat";
const char *websockets_server1 = "wss://iat-api.xfyun.cn/v2/iat";
using namespace websockets;
